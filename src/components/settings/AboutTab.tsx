    ...
    <div className="space-y-6 py-4">
      ...
      <div className="flex flex-wrap gap-3">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 rounded-lg bg-surface-hover px-4 py-2 text-fluid-sm font-semibold text-text transition-colors hover:bg-border"
        >
